...
class PurePath(PathLike[str]):
    ...
    # Bitranox Addons
    #############################
    def append_suffix(self: Self, suffix: str) -> Self: ...
    def replace_parts(self: Self, old: Self, new: Self) -> Self: ...
    @staticmethod
...
class Path(PurePath):
    ...
    # Bitranox Addon
    def copy(self: Self, target: PurePath, follow_symlinks: bool = ...) -> None: ...
    def copy2(self: Self, target: PurePath, follow_symlinks: bool = ...) -> None: ...
    def copyfile(self: Self, target: PurePath, follow_symlinks: bool = ...) -> None: ...
    def copymode(self: Self, target: PurePath, follow_symlinks: bool = ...) -> None: ...
    def copystat(self: Self, target: PurePath, follow_symlinks: bool = ...) -> None: ...
    def copytree(self: Self,
                 target: PurePath,
                 symlinks: bool = ...,
    ...
    def rmtree(self: Self,  ignore_errors: bool = ..., onerror: Optional[Callable[[Any, Any, Any], Any]] = ...) -> None: ...
